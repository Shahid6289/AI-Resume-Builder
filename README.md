...
1. **Clone the Repository**
   ...
   ```bash
   git clone git@github.com:Shahid6289/AI-Resume-Builder.git
   ```
...
For any questions or feedback, please reach to me directly  [Shahid Parvez](https://github.com/Shahid6289).
